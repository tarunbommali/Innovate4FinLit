...
var RulesService = /** @class */ (function () {
    ...
    RulesService.prototype.getCachedRules = function (userGroup) {
        return __awaiter(this, void 0, void 0, function () {
            var scenarios, scenarioIds, rules;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.scenario.findMany({
    ...
    RulesService.prototype.evaluateOffline = function (scenarioId, choiceId, rules) {
        var rule = rules.find(function (r) { return r.scenarioId === scenarioId && r.choiceId === choiceId; });
        if (!rule) {
            return {
                scoreChange: 0,
...
exports.default = new RulesService();
