...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.register = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var existingUser, passwordHash, user, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, prisma.progress.create({
                                data: {
                                    userId: user.id
                                }
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, bcrypt_1.default.compare(credentials.password, user.passwordHash)];
                    case 2:
                        isValid = _a.sent();
                        if (!isValid) {
                            throw new Error('INVALID_CREDENTIALS');
