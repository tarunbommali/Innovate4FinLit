...
var ScenarioService = /** @class */ (function () {
    ...
    ScenarioService.prototype.getScenarios = function (userGroup, theme) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prisma.scenario.findMany({
                                where: where,
                                select: {
                                    id: true,
                                    title: true,
                    ...
                    case 1:
                        scenarios = _a.sent();
                        return [2 /*return*/, scenarios.map(function (s) { return ({
                                scenarioId: s.id,
                                title: s.title,
                                context: s.context,
    ...
    ScenarioService.prototype.getScenarioById = function (scenarioId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.scenario.findUnique({
                            where: { id: scenarioId }
                        })];
                    case 1:
                        scenario = _a.sent();
